...
export default function Chatroom() {  
  ...
  const signInWithEmail = async () => {  
    ...
    if (error) { setError('Error sending OTP. Please try again.'); }  
    else {  
      setOtpSent(true);  
      setError('');  
  ...
  const verifyOtp = async () => {  
    if (!otp || !email) { setError('Please enter the OTP sent to your email.'); return; }  
  ...
  return (  
    <div id="chat-container">  
      ...
      <div id="typing-indicator"><p>{typingUsers.size} users typing...</p></div>  
